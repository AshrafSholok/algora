    ...
    <section className="py-20 mt-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-900 font-bold mb-4">Drop Us Message For Any Question</p>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-1/2  flex items-center justify-center p-12">
              <img 
                src="../../src/assets/svg/contact.png" 
            ...
            {/* Right side - Form */}
            <div className="md:w-1/2 xl:w-3/4 p-12 bg-gray-100">
              <form>
