            ...
            <nav className=" border-gray-200 px-4 lg:px-6 py-5 ">  {/* dark:bg-gray-800 */} 
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="/" className="flex items-center">
                        <img src="../../src/assets/images/logo.png" className="mr-3 h-10 sm:h-12" alt="Flowbite Logo" />
                        {/* <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-blue">Algora +</span> */}
                    </a>
                    <div className="flex items-center lg:order-2">
                        ...
                        <a href="/contactus" className="text-white bg-primary-500 hover:bg-primary-600 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 transition-all duration-300">Get started</a>
                        <button
                            type="button"
